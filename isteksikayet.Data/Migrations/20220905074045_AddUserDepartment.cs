    ...
    public partial class AddUserDepartment : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComplaintReplays", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ComplaintReplays_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ComplaintReplays_Complaints_ComplaintId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ComplaintReplays_ComplaintId",
                table: "ComplaintReplays",
                column: "ComplaintId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ComplaintReplays_UserId",
                table: "ComplaintReplays",
                column: "UserId");
