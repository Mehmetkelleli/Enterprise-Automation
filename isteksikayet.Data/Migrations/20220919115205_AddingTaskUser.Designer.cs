...
namespace isteksikayet.Data.Migrations
{
    ...
    [Migration("20220919115205_AddingTaskUser")]
    partial class AddingTaskUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("isteksikayet.Entity.SiteConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("isteksikayet.Entity.Task", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("isteksikayet.webui.Identity.User", b =>
                {
            ...
            modelBuilder.Entity("isteksikayet.Entity.Complaint", b =>
                {
                    ...
                    b.HasOne("isteksikayet.webui.Identity.User", "User")
                        .WithMany("Complaint")
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("isteksikayet.Entity.Task", b =>
                {
                    b.HasOne("isteksikayet.webui.Identity.User", "CreatedUser")
                        .WithMany()
                    ...
                    b.HasOne("isteksikayet.webui.Identity.User", "TaskUser")
                        .WithMany()
